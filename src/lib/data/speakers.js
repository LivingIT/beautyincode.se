/**
 * @type {Object.<string, { name: string, image: string, bio: string }>}
 */
const speakers = {
  'lisette-sutherland': {
  ...
  'jonah-andersson': {
    ...
    image: '/images/speakers/jonah-andersson.webp',
    bio: `
  ...
  'kesha-williams': {
    name: 'Kesha Williams',
    image: '/images/speakers/kesha-williams.webp',
    bio: `
  ...
  'niall-merrigan': {
    name: 'Niall Merrigan',
    image: '/images/speakers/niall-merrigan.webp',
    bio: `
  ...
  'dylan-beattie': {
    ...
    bio: `
      <p>Dylan Beattie is a consultant, software developer and international keynote speaker.
      He’s been building web applications since the 1990s, and works primarily on Microsoft .NET, HTTP APIs, UX design, and distributed systems.</p>

      <p>Dylan lives and works in London and when he’s not writing code he plays guitar and writes songs.</p>
    `,
  },
};
